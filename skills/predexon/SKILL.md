...
**Dual proxy:** These `/v1/pm/*` calls must go to the **x402** OmbRouter instance (examples use `localhost:8402`). See [dual-proxy-deployment.md](../../docs/dual-proxy-deployment.md).
