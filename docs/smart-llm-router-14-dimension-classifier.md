...
```
Setup:     OmbRouter v0.12.47 proxy on localhost
...
Raw data (55+ models, latency, throughput, IQ scores, pricing): [`benchmark-merged.json`](https://github.com/BlockRunAI/OmbRouter/blob/main/benchmark-merged.json)

Routing configuration: [`src/router/config.ts`](https://github.com/BlockRunAI/OmbRouter/blob/main/src/router/config.ts)

Scoring implementation: [`src/router/rules.ts`](https://github.com/BlockRunAI/OmbRouter/blob/main/src/router/rules.ts)
