# OmbRouter E2E Testing, Docker Validation & Deployment

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Comprehensive E2E test coverage, Docker install/uninstall validation (10 cases), and automated deployment pipeline for OmbRouter.
...
**Goal:** Validate OmbRouter installation, upgrade, uninstall across different methods and environments.
...
test_fresh_install() {
  echo "Installing ombrouter globally..."
  npm install -g ombrouter@latest

  echo "Verifying ombrouter command exists..."
  which ombrouter || return 1

  echo "Checking version..."
  ombrouter --version || return 1

  echo "Verifying package is in npm global list..."
  npm list -g ombrouter || return 1
...
test_uninstall() {
  echo "Uninstalling ombrouter..."
  npm uninstall -g ombrouter

  echo "Verifying ombrouter command is gone..."
  if which ombrouter 2>/dev/null; then
    echo "ERROR: ombrouter command still exists after uninstall"
    return 1
  fi

  echo "Verifying package is not in npm global list..."
  if npm list -g ombrouter 2>/dev/null; then
...
test_openclaw_plugin_install() {
  ...
  echo "Installing OmbRouter as OpenClaw plugin..."
  openclaw plugins install ombrouter || return 1

  echo "Verifying plugin is listed..."
  openclaw plugins list | grep -q "ombrouter" || return 1
...
test_openclaw_plugin_uninstall() {
  ...
  echo "Uninstalling OmbRouter plugin..."
  openclaw plugins uninstall ombrouter || return 1

  echo "Verifying plugin is removed..."
  if openclaw plugins list 2>/dev/null | grep -q "ombrouter"; then
...
test_upgrade() {
  ...
  npm install -g ombrouter@0.8.25

  echo "Verifying old version..."
  local old_version=$(ombrouter --version)
  ...
  local new_version=$(ombrouter --version)
...
test_package_files() {
  echo "Installing ombrouter..."
  npm install -g ombrouter@latest

  echo "Finding package installation directory..."
  local pkg_dir=$(npm root -g)/ombrouter
...
test_version_command() {
  ...
  local cli_version=$(ombrouter --version)
...
test_full_cleanup() {
  ...
  echo "Finding all OmbRouter files..."
  local pkg_dir=$(npm root -g)/ombrouter
  local bin_link=$(which ombrouter)
...
# Run all tests
echo "╔════════════════════════════════════════════════════════╗"
echo "║   OmbRouter Docker Installation Test Suite          ║"
echo "╚════════════════════════════════════════════════════════╝"
...
╔════════════════════════════════════════════════════════╗
║   OmbRouter Docker Installation Test Suite          ║
╚════════════════════════════════════════════════════════╝

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Test: 1. Fresh npm global installation
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Installing ombrouter globally...
Verifying ombrouter command exists...
Checking version...
0.8.30
✓ PASS
...
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}  OmbRouter Deployment Pipeline${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
...
if command -v gh &> /dev/null; then
  ...
  echo "Create release manually at: https://github.com/BlockRunAI/OmbRouter/releases/new"
fi
...
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo "Package: ombrouter@$NEW_VERSION"
echo "npm: https://www.npmjs.com/package/ombrouter"
echo "GitHub: https://github.com/BlockRunAI/OmbRouter/releases/tag/v$NEW_VERSION"
echo ""
```
...
````markdown
# OmbRouter Deployment Guide

## Prerequisites

1. **npm account with publish access** to `ombrouter`
...
1. Check npm package: https://www.npmjs.com/package/ombrouter
2. Verify installation: `npm install -g ombrouter@latest`
3. Test version: `ombrouter --version`
4. Check GitHub release: https://github.com/BlockRunAI/OmbRouter/releases
...
npm unpublish ombrouter@0.8.31
```
