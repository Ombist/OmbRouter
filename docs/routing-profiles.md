...
OmbRouter offers four routing profiles to balance cost vs quality. Prices are in **$/M tokens** (input/output).
...
Use `blockrun/agentic` for autonomous multi-step tasks, or let OmbRouter auto-detect agentic patterns.
...
OmbRouter automatically classifies your query into one of four tiers:
