...
- **Date:** March 16, 2026
- **Setup:** BlockRun OmbRouter v0.12.47 proxy on localhost, connected to BlockRun's x402 payment gateway on Base (EVM)
...
Raw benchmark data: [benchmark-results.json](https://github.com/BlockRunAI/OmbRouter/blob/main/benchmark-results.json)
